...
const TimerContainer: React.FC = () => {
  const { timerState, updateSettings } = useTimerContext();
  const [showSettings, setShowSettings] = useState(false);
  const [showHelp, setShowHelp] = useState(false);
  
  const [workDuration, setWorkDuration] = useState(timerState.settings.workDuration);
  const [breakDuration, setBreakDuration] = useState(timerState.settings.breakDuration);
  const [longBreakDuration, setLongBreakDuration] = useState(timerState.settings.longBreakDuration);
  const [longBreakInterval, setLongBreakInterval] = useState(timerState.settings.longBreakInterval);
