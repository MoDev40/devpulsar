...
interface TaskState {
  ...
  addTask: (title: string, category: TaskCategory, priority: TaskPriority) => Promise<void>;
...
export const useTaskStore = create<TaskState>((set, get) => {
  ...
  return {
    ...
    addTask: async (title: string, category: TaskCategory, priority: TaskPriority) => {
      const { user } = useAuthStore.getState();
    ...
    toggleTaskCompletion: async (id: string) => {
      ...
      try {
        ...
        await updateTaskCompletion(id, updatedTask.completed);
      } catch (error: any) {
    ...
    editTask: async (id: string, updates: Partial<Omit<Task, 'id' | 'createdAt'>>) => {
      const { user } = useAuthStore.getState();
